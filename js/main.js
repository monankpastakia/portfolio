...
// Select all anchor tags with the class 'disable-click'
const links = document.querySelectorAll('.disable-click');
  
links.forEach(link => {
  link.addEventListener('click', function(event) {
	event.preventDefault(); // Disable the default click action
  });
});